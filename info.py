...
SHORTENER_API = environ.get("SHORTENER_API", "4efa5371846bc9d04b47304acfd8d72636009021")
...
REF_PREMIUM = 10
PREMIUM_POINT = 1000
auth_channel = environ.get('AUTH_CHANNEL', '-1002827693842') #if upload
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002827693842')) #for channel post 
